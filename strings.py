...
MC_PROB_RUIN = "P(quiebra técnica) — valor < 1 € en algún momento"
MC_PROB_LOSS_GIVEN_RUIN = "P(pérdida final | quiebra técnica)"
MC_PROB_DEEP_DRAWDOWN = "P(caída profunda) — valor < 10 % del total invertido en algún momento"
